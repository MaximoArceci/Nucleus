...
import home from "assets/images/nucleus-logo.png";
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-6 py-4 lg:px-24">
        <a href="#">
          <img src={home} alt="Nucleus" className={` ${showMenu && "hidden"} ${isMobile ? "h-14" : "absolute top-0 left-10 h-40"}`} />
        </a>

        {/* Menú para escritorio */}
        {!isMobile && (
          <ul className="flex space-x-8 font-semibold text-sm">
            <li><a href="#home" className="nav-links" onClick={(e) => handleScroll(e, "home")}>Inicio</a></li>
            <li><a href="#about" className="nav-links" onClick={(e) => handleScroll(e, "products")}>Áreas</a></li>
            <li><a href="#products" className="nav-links" onClick={(e) => handleScroll(e, "design")}>Comunidad</a></li>
